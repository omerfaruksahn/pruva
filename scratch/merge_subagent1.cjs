...
const subagentScratchDir = 'c:\\Users\\Ömer\\.gemini\\antigravity\\brain\\6b769998-3ef4-49ee-9fef-bcb683c78d24\\scratch';

const jsonFiles = [
    'translations_postAd.json',
    'translations_marketplace.json',
    'translations_loaderDashboard.json',
    'translations_carrierDashboard.json'
];
